...
ActiveRecord::Schema.define(version: 20180308140900) do
  ...
  create_table "trip_check_points", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "trip_id"
    t.integer "speed"
    ...
    t.index ["trip_id"], name: "index_trip_check_points_on_trip_id"
    t.index ["user_id"], name: "index_trip_check_points_on_user_id"
  end
